...
namespace Diplom
{
    ...
    public partial class MainForm : Form
    {
        ...
        {
            float deltaX = mouseOldPos.X - e.X;
            float deltaY = mouseOldPos.Y - e.Y;

            switch (e.Button)
            {
                case MouseButtons.Middle:
                    modelViewerControl.Camera.RotateAroundTarget(deltaX, deltaY);
        ...
        {
            modelViewerControl.Camera.MoveToTarget(e.Delta);
        }
    }
}
